...
const AboutPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 transition-colors selection:bg-primary-500/30">
            {/* Navigation Header */}
                ...
                <div className="max-w-5xl mx-auto px-6 h-20 flex items-center justify-between">
                    <div className="flex items-center gap-6">
                        <button 
                            ...
                            className="p-3 bg-gray-50 hover:bg-gray-100 rounded-2xl transition-all text-gray-500 group active:scale-90"
                        >
                            <ArrowLeft size={20} className="group-hover:-translate-x-1 transition-transform" />
                        </button>
                        <div>
                            <h1 className="text-xl font-black text-gray-900 uppercase tracking-wider">Mission & Evolution</h1>
            ...
            <main className="max-w-5xl mx-auto px-6 py-12 space-y-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-7 space-y-12">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-8 bg-white rounded-[2.5rem] border border-gray-100 shadow-xl hover:shadow-2xl transition-all group">
                                ...
                                <h4 className="text-xl font-black text-gray-900 mb-2">Secure by Design</h4>
                            ...
                            <div className="p-8 bg-white rounded-[2.5rem] border border-gray-100 shadow-xl hover:shadow-2xl transition-all group">
                                ...
                                <h4 className="text-xl font-black text-gray-900 mb-2">Ultra Performance</h4>
                                <p className="text-sm text-gray-500 font-medium leading-relaxed">
                    ...
                    <div className="lg:col-span-5 space-y-12">
                        {/* Developer Spotlight */}
                        <div className="bg-white rounded-[3rem] p-8 border border-primary-500/10 shadow-2xl relative overflow-hidden group">
                            ...
                            <div className="space-y-8 relative z-10">
                                <div className="text-center space-y-4">
                                    <div className="w-24 h-24 mx-auto rounded-3xl bg-linear-to-br from-primary-500 to-indigo-600 p-1 shadow-2xl rotate-6 group-hover:rotate-0 transition-all duration-500">
                                        <div className="w-full h-full bg-white rounded-[calc(1.5rem-4px)] flex items-center justify-center font-black text-primary-600 text-3xl">SM</div>
                                    </div>
                                    <div>
                                        ...
                                        <h3 className="text-3xl font-black text-gray-900 tracking-tight">Siddhant Mishra</h3>
                                ...
                                <div className="pt-6 border-t border-gray-100">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {['MERN Stack', 'Socket.io', 'Tailwind v4', 'Cloudinary', 'Lucide'].map(tech => (
                                            <span key={tech} className="px-3 py-1.5 bg-gray-50 text-gray-600 text-[10px] font-bold rounded-lg border border-gray-100">
                                                {tech}
                                            </span>
                                        ))}
                                    </div>
                        ...
                        {/* Version Info */}
                        <div className="bg-linear-to-br from-gray-900 to-black rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden">
                ...
                {/* Footer Section */}
                <footer className="pt-12 border-t border-gray-100 text-center space-y-6">
                    <div className="flex justify-center gap-6">
                        <MessageSquare className="text-primary-500/30" size={40} />
                    </div>
                    <div>
                        <p className="text-sm font-black text-gray-900 uppercase tracking-widest mb-2">Vaani Messenger</p>
